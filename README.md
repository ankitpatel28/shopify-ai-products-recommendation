# Cross-Browser Cart Support - Shopify App

A Shopify app built with Remix that enables cross-browser cart synchronization for customers.

## Features

- ✨ **Cross-Browser Cart Sync** - Customers can access their cart from any browser
- 🔄 **Automatic Synchronization** - Cart items are automatically saved and restored
- 🛍️ **Cart Transform Function** - Real-time cart processing using Shopify Functions
- 📦 **Metafield Storage** - Secure storage of cart data in customer metafields
- 🌐 **App Proxy API** - RESTful endpoints for cart management
- 🎯 **Remix + Shopify App** - Modern app architecture with Remix framework

## Quick Links

- **[How to Run](./HOW_TO_RUN.md)** - Step-by-step guide to run and test the cart transform
- **[Integration Guide](./CART_SYNC_INTEGRATION.md)** - Client-side integration instructions
